...
export const ROUTE_NAMES = {
  ...
  MARKETING: {
    ...
    TASKS: {
      ROOT: 'marketing-tasks',
      CREATE: 'marketing-tasks-create',
      EDITOR: 'marketing-tasks-editor'
    },
    BENEFIT: {
      ROOT: 'benefitConfig',
      TEMPLATE: 'template',
...
export const ROUTE_PATHS = {
  ...
  BUDGET: {
    ...
    ALLOCATION: '/budget/allocation/:id',
    MONITOR: '/budget/monitor',
    ALERTS: '/budget/alerts'
  }
}
...
// 面包屑配置 - 预算管理模块
export const BUDGET_BREADCRUMB_CONFIG = {
  [ROUTE_NAMES.BUDGET.OVERVIEW]: [
    { title: '预算管理', path: ROUTE_PATHS.BUDGET.ROOT },
    { title: '预算总览', path: ROUTE_PATHS.BUDGET.OVERVIEW }
  ],
  [ROUTE_NAMES.BUDGET.CREATE]: [
    { title: '预算管理', path: ROUTE_PATHS.BUDGET.ROOT },
    { title: '新建预算', path: ROUTE_PATHS.BUDGET.CREATE }
  ],
  [ROUTE_NAMES.BUDGET.DETAIL]: [
    { title: '预算管理', path: ROUTE_PATHS.BUDGET.ROOT },
    { title: '预算详情', path: ROUTE_PATHS.BUDGET.DETAIL }
  ],
  [ROUTE_NAMES.BUDGET.EDIT]: [
    { title: '预算管理', path: ROUTE_PATHS.BUDGET.ROOT },
    { title: '编辑预算', path: ROUTE_PATHS.BUDGET.EDIT }
  ],
  [ROUTE_NAMES.BUDGET.ALLOCATION]: [
    { title: '预算管理', path: ROUTE_PATHS.BUDGET.ROOT },
    { title: '预算分配', path: ROUTE_PATHS.BUDGET.ALLOCATION }
  ],
  [ROUTE_NAMES.BUDGET.MONITOR]: [
    { title: '预算管理', path: ROUTE_PATHS.BUDGET.ROOT },
    { title: '预算监控', path: ROUTE_PATHS.BUDGET.MONITOR }
  ],
  [ROUTE_NAMES.BUDGET.ALERTS]: [
    { title: '预算管理', path: ROUTE_PATHS.BUDGET.ROOT },
    { title: '预算预警', path: ROUTE_PATHS.BUDGET.ALERTS }
  ]
}
...
export const BREADCRUMB_CONFIG = {
  ...
  [ROUTE_NAMES.MARKETING.TASKS.ROOT]: [
    { title: '营销管理', path: ROUTE_PATHS.MARKETING.ROOT },
    { title: '营销任务', path: ROUTE_PATHS.MARKETING.TASKS.ROOT }
  ],
  [ROUTE_NAMES.MARKETING.TASKS.CREATE]: [
    { title: '营销管理', path: ROUTE_PATHS.MARKETING.ROOT },
    { title: '营销任务', path: ROUTE_PATHS.MARKETING.TASKS.ROOT },
    { title: '创建任务', path: ROUTE_PATHS.MARKETING.TASKS.CREATE }
  ],
  [ROUTE_NAMES.MARKETING.TASKS.EDITOR]: [
    { title: '营销管理', path: ROUTE_PATHS.MARKETING.ROOT },
    { title: '营销任务', path: ROUTE_PATHS.MARKETING.TASKS.ROOT },
    { title: '任务编辑', path: ROUTE_PATHS.MARKETING.TASKS.EDITOR }
  ],
  ...
  main: [
    {
      ...
      children: [
        ...
        },
        {
          key: 'marketing-tasks',
          title: '营销任务',
          path: ROUTE_PATHS.MARKETING.TASKS.ROOT
        },
        {
