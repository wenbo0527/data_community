...
const form = ref({ name: '', code: '', type: '', framework: '', version: '', variableVersion: 'new', description: '', parameters: '' })
...
onMounted(async () => {
  try {
    ...
    form.value = {
      ...
      variableVersion: data?.variableVersion || 'new',
...
const handleCancel = () => {
  goBack(router, '/risk/model-offline-analysis/model-register')
}
</script>
