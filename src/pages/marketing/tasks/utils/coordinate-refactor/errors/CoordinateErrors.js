...
export class BranchFlowError extends CoordinateCalculationError {
  constructor(message, sourceNodeId = null, branchId = null) {
    super(message, sourceNodeId, { branchId });
...
export class ErrorFactory {
   ...
   * 创建分流管理错误
   */
  static createBranchFlowError(message, sourceNodeId, branchId) {
    return new BranchFlowError(message, sourceNodeId, branchId);
  }
}
...
export class ErrorHandler {
  ...
  handleBranchFlowError(error, context) {
    console.warn(`⚠️ [错误处理] 分流管理错误，源节点: ${error.nodeId}, 分支: ${error.branchId}`);
  }
