    ...
    <div class="test-sections">
      <div class="test-section">
        ...
        <a-space direction="vertical" style="width: 100%">
          <a-button type="primary" @click="$router.push('/offline-model/feature-center')">
            特征中心
          </a-button>
          <a-button type="primary" @click="$router.push('/offline-model/model-register')">
            模型注册
          </a-button>
          <a-button type="primary" @click="$router.push('/offline-model/model-backtrack')">
            模型回溯
          </a-button>
          <a-button type="primary" @click="$router.push('/offline-model/task-management')">
            任务管理
          </a-button>
          <a-button type="primary" @click="$router.push('/offline-model/model-evaluation')">
            模型评估
          </a-button>
        </a-space>
      </div>
