...
describe('workflowNodeTypes 图标导入测试', () => {
  ...
  it('NODE_TYPE_ICON_MAP 应该包含所有节点类型的有效图标', () => {
    ...
    expect(NODE_TYPE_ICON_MAP[NodeType.PROCESSING]).toBe(IconCode);
  ...
  it('所有工具函数应该正常工作', () => {
    ...
    expect(getNodeTypeName(NodeType.PROCESSING, 'PYTHON')).toBe('Python处理');
    ...
    expect(getNodeTypeColor(NodeType.PROCESSING, 'PYTHON')).toBe('#52c41a');
