...
// 调额历史记录扩展接口
interface QuotaAdjustHistory {
  customerNo: string;
  productKey?: string;
  productName?: string; // 产品名称
  adjustDate: string;
  adjustmentDate?: string; // 调额日期（映射自adjustDate）
  beforeAmount: number;
  previousAmount?: number; // 调额前金额（映射自beforeAmount）
  afterAmount: number;
  newAmount?: number; // 调额后金额（映射自afterAmount）
  adjustmentAmount?: number; // 调额金额（计算得出）
  type?: string; // 调额类型（根据金额变化计算）
  adjustReason: string;
  beforeRate: number;
  afterRate: number;
  beforePeriod: number;
...
interface MarketingRecord {
  ...
  touchRecords: Array<{
    ...
    content: string;
    // 渠道特定字段
    duration?: string;      // 通话时长 (e.g. "45s")
    recordingUrl?: string;  // 录音地址
    transcript?: string;    // 通话转写/短信全文
...
interface EnhancedLoanRecord {
  loanNo: string;
  loanId?: string;               // 用信ID（映射自loanNo）
  productKey: string;
  loanDate: string;
  dueDate?: string;              // 到期日期（映射自nextPaymentDate）
  ...
  status: string;
  amount: number;
  loanAmount?: number;           // 借款金额（映射自amount）
  balance: number;
  remainingAmount?: number;      // 剩余金额（映射自balance）
  installments: number;
  ...
  settlementDate?: string | null | undefined;       // 结清日期
  ...
  // 实时数据字段
  realTimeBalance?: number;      // 实时余额
  dailyDisbursement?: number;    // 当日放款金额
  dailyRepayment?: number;       // 当日还款金额
...
const mockUsers: { [key: string]: UserData } = {
  ...
  '887123': {
      ...
      touchRecords: [
        {
          ...
          touchDate: '2024-01-25 10:30:00',
          touchChannel: 'AI外呼',
          campaignName: '新春理财节',
          campaignType: '产品推广',
          content: '尊敬的客户，新春理财产品上线，年化收益率高达6.8%，欢迎选购。',
          duration: '45s',
          recordingUrl: 'mock_audio_01.mp3',
          transcript: 'AI: 尊敬的客户您好，这里是某某银行。新春理财节火热开启，年化收益率高达6.8%。\n客户: 具体的起投金额是多少？\nAI: 起投金额仅需1万元。您感兴趣吗？\n客户: 可以发个链接看看。',
        ...
        },
        {
          id: 'TCH002',
          productKey: 'LN-2024-001',
          touchDate: '2024-01-25 10:31:00',
          touchChannel: 'AI外呼挂短',
          campaignName: '新春理财节详情',
          campaignType: '产品推广',
          content: '【某某银行】您刚才咨询的理财产品详情请点击：t.cn/xxxyyy 退订回T',
          duration: '12s',
          transcript: 'AI: 好的，这就为您发送产品详情短信，请注意查收。',
          targetAudience: '高净值客户',
          touchResult: '成功',
          responseAction: '点击',
        ...
        },
        {
          id: 'TCH003',
          productKey: 'LN-2024-002',
          touchDate: '2024-01-20 14:00:00',
          touchChannel: '人工外呼',
          campaignName: '大额贷款回访',
          campaignType: '客户关怀',
          content: '核实客户贷款意向及还款能力',
          duration: '3m 20s',
          recordingUrl: 'mock_audio_02.mp3',
          transcript: '经理: 张先生您好，我是您的专属客户经理。\n客户: 你好，什么事？\n经理: 看到您最近关注了大额贷款产品，想了解下您的具体需求...\n(通话持续3分钟)',
          targetAudience: '贷款客户',
          touchResult: '成功',
          responseAction: '接通',
          conversionValue: 0,
        ...
        },
        {
          id: 'TCH004',
          productKey: 'LN-2024-002',
          touchDate: '2024-01-20 14:10:00',
          touchChannel: '人工外呼挂短',
          campaignName: '贷款经理名片',
          campaignType: '客户关怀',
          content: '【某某银行】我是您的专属客户经理张三，电话138xxxx，有需求随时联系。',
          duration: '50s',
          targetAudience: '贷款客户',
          touchResult: '成功',
          responseAction: '保存',
        ...
        },
        {
          id: 'TCH005',
          productKey: 'LN-2024-003',
          touchDate: '2024-01-15 09:30:00',
          touchChannel: '短信',
          campaignName: '信用卡账单提醒',
          campaignType: '风险提醒',
          content: '【某某银行】您本期账单金额5000元，还款日1月25日。',
      ...
      benefitRecords: [
        {
          id: 'BEN001',
          productKey: 'LN-2024-001',
          benefitDate: '2024-01-26',
          benefitType: '利息减免',
          benefitName: '首期利息减免券',
          benefitValue: 500,
          benefitStatus: '已发放',
          expiryDate: '2024-02-26',
          sourceActivity: '新春理财节',
          usageRestriction: '仅限理财产品'
        },
        {
          id: 'BEN002',
          productKey: 'LN-2024-002',
          benefitDate: '2024-01-21',
          benefitType: '折扣',
          benefitName: '贷款利率8.5折卡',
          benefitValue: 0.85,
          benefitStatus: '已核销',
          useDate: '2024-01-22',
          expiryDate: '2024-02-21',
          sourceActivity: '大额贷款回访',
          usageRestriction: '仅限个人消费贷'
        },
        {
          id: 'BEN003',
          productKey: 'LN-2024-003',
        ...
        },
        {
          ...
          benefitType: '体验金',
          benefitName: '理财体验金10000元',
          benefitValue: 10000,
          benefitStatus: '已过期',
          expiryDate: '2024-01-07',
          sourceActivity: '元旦活动',
          usageRestriction: '仅限体验标'
        }
      ],
      effectAnalysis: {
        totalTouchCount: 5,
    ...
    paymentProcessRecords: {
      ...
      repaymentRecords: [
        {
          paymentId: 'RP-20230915-001',
          productKey: 'LN-2024-002',
          status: '成功',
          amount: 2500,
          paymentMethod: '自动扣款',
          paymentTime: '2023-09-15',
          type: '还款记录',
        ...
        {
          paymentId: 'RP-20231015-001',
          productKey: 'LN-2024-002',
          status: '成功',
          amount: 2500,
          paymentMethod: '自动扣款',
          paymentTime: '2023-10-15',
          type: '还款记录',
      ...
      if (userData) {
        ...
        console.debug('[数据完整性检查] 用户数据结构:', {
          ...
          firstProduct: userData.products && userData.products.length > 0 ? {
            hasProductKey: 'productKey' in (userData.products[0] as any) || false,
            hasProductName: 'productName' in (userData.products[0] as any) || false,
            hasProductType: 'productType' in (userData.products[0] as any) || false,
            hasAmount: 'amount' in (userData.products[0] as any) || false,
            hasStartDate: 'startDate' in (userData.products[0] as any) || false,
            hasRate: 'rate' in (userData.products[0] as any) || false
          } : null
        });
