...
export interface ExternalDataDetail {
  ...
  usageInfo: Array<{ label: string; value: string }>
  evaluationInfo: Array<{ label: string; value: string }>
}
 ...
 */
export const generateExternalDataDetail = (id: string): ExternalDataDetail => {
 ...
 */
export const generateExternalDataStatistics = (): ExternalDataStatistics => {
  return {
    registering: 10,
    pending: 5,
    online: 25,
