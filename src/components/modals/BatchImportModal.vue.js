...
const __VLS_16 = {
    onClick: (...[$event]) => {
        __VLS_ctx.downloadTemplate('batch');
    }
};
...
const __VLS_22 = __VLS_asFunctionalComponent(__VLS_21, new __VLS_21({
    ...
    ...{ 'onDragleave': {} },
    showFileList: (false),
    customRequest: (__VLS_ctx.handleBatchUpload),
    accept: ".xlsx,.xls",
    drag: true,
    ...{ class: "upload-area" },
...
const __VLS_28 = {
    onChange: (...[$event]) => {
        __VLS_ctx.handleFileChange('batch', $event, __VLS_ctx.batchFileCount);
    }
};
const __VLS_29 = {
...
if (__VLS_ctx.batchFileCount > 0) {
    ...
    let __VLS_58;
    const __VLS_59 = {
        onClick: (__VLS_ctx.confirmBatchUpload)
    };
