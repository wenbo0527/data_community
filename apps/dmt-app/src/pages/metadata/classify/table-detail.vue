<template>
  <div class="classify-table-detail-page">
    ...
    <DmtPageHeader :title="tableData?.table_name || '表详情'" :sub-title="tableData?.table_comment || ''">
      <template #extra>
        <a-space>
...
import { classifyEditHistory } from '@shared/classify-edit-history'
import { SENSITIVITY_COLORS, SENSITIVITY_NAMES, GRADE_OPTIONS, BELONGING_OPTIONS, MOCK_ROLES } from '@shared/classify-constants'
import type { ClassifyField, ClassifyTable } from '@shared/classify-types'
...
const goToTables = () => router.push(`/metadata/classify/tables/${systemId.value}`)
