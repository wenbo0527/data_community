...
const goHome = () => {
  ...
  let homePath = '/asset-management/listing-management/asset-management'
  if (path.includes('/data-source/')) {
    homePath = '/asset-management/listing-management/data-source'
  } else if (path.includes('/element-management/')) {
    homePath = '/asset-management/listing-management/element-management'
  }
