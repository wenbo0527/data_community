...
const applyFilters = () => {}
const resetFilters = () => {
  (filterForm as any).year = undefined
  ;(filterForm as any).quarter = undefined
  ;(filterForm as any).month = undefined
  ;(filterForm as any).productType = undefined
  ;(filterForm as any).platform = undefined
}
