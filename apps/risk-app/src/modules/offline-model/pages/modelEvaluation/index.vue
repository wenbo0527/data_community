...
const handleCreateEvaluation = () => {
  router.push('/model-offline-analysis/model-evaluation/create')
}

 

const handleViewModel = (record) => {
  router.push(`/model-offline-analysis/model-register/detail/${record.modelId}`)
}

const handleViewDetail = (record) => {
  router.push(`/model-offline-analysis/model-evaluation/detail/${record.id}`)
}
