...
export const MODEL_BACKTRACK_ROUTES = {
  // 离线模块基础路径
  BASE: '/model-offline-analysis/model-backtrack',
  // 列表页
  LIST: '/model-offline-analysis/model-backtrack',
  // 创建页
  CREATE: '/model-offline-analysis/model-backtrack/create',
  // 详情页
  DETAIL: '/model-offline-analysis/model-backtrack/detail',
  // 报告页（详情页的报告标签）
  REPORT: '/model-offline-analysis/model-backtrack/detail'
}
