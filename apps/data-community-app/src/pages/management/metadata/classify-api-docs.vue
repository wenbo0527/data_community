<template>
  ...
  <div class="classify-api-docs-page">
    <PageHeader title="分级分类 API 文档" :sub-title="`对外提供分级分类标签查询接口（Demo 模式，仅展示）· 共 ${apis.length} 个接口`" />
...
import { classifyApiDocsData } from '@/mock-shared/classify-api-docs'
import type { ClassifyApiDoc } from '@/mock-shared/classify-types'
