...
import {
  ...
  deleteDataModel,
  copyDataModel
} from '@mock-dca/api/dataModels'
import StatusTag from '@/components-dca/common/StatusTag.vue'
...
const handleView = (record) => {
  router.push(`/management/data-models/detail/${record.id}`)
}

const handleEdit = (record) => {
  router.push(`/management/data-models/edit/${record.id}`)
}
