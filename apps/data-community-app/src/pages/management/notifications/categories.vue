  ...
  <div class="categories-page">
    ...
    <div class="page-header">
      <div class="header-left">
        <a-breadcrumb>
          <a-breadcrumb-item @click="$router.push('/management/notifications')">
            通知管理
          </a-breadcrumb-item>
...
import { NotificationAPI, CategoryAPI } from '@mock-dca/api/notification'
...
// 颜色选项
const colorOptions = [
  { value: 'blue', label: '蓝色', color: 'var(--subapp-primary)' },
  { value: 'green', label: '绿色', color: 'var(--subapp-success)' },
  { value: 'orange', label: '橙色', color: 'var(--subapp-warning)' },
  { value: 'red', label: '红色', color: 'var(--subapp-danger)' },
  { value: 'purple', label: '紫色', color: '#722ed1' },
  { value: 'cyan', label: '青色', color: '#14c9c9' },
  { value: 'magenta', label: '品红', color: 'var(--subapp-danger)' },
  { value: 'lime', label: '青柠', color: 'var(--subapp-success)' },
  { value: 'gold', label: '金色', color: 'var(--subapp-warning)' },
  { value: 'gray', label: '灰色', color: 'var(--subapp-text-tertiary)' }
]
...
const viewCategoryNotifications = (categoryId) => {
  router.push({
    path: '/management/notifications/list',
    query: { categoryId }
  })
}
...
const getColorValue = (colorName) => {
  ...
  return colorOption?.color || 'var(--subapp-primary)'
}
