...
const handleCreate = () => {
  router.push('/management/data-standard/domains/edit')
}
...
const handleView = (record) => {
  router.push(`/management/data-standard/domains/detail/${record.id}`)
}

const handleEdit = (record) => {
  router.push(`/management/data-standard/domains/edit/${record.id}`)
}
