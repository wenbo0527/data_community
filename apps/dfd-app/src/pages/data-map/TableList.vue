...
/* 主题颜色类 (复用) */
.theme-blue { background: linear-gradient(135deg, var(--subapp-primary) 0%, #4080FF 100%); }
.theme-green { background: linear-gradient(135deg, var(--subapp-success) 0%, #23C343 100%); }
...
.theme-arcoblue { background: linear-gradient(135deg, var(--subapp-primary) 0%, #4080FF 100%); }
.theme-gray { background: linear-gradient(135deg, var(--subapp-text-tertiary) 0%, #A9B3C1 100%); }
