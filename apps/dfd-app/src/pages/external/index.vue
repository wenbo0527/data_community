                    ...
                    <div class="info-item">
                      ...
                      <a-space>
                        <template v-if="item.isPrimary">
                          <a-link :style="{ color: 'var(--subapp-primary)' }">{{ item.interfaceId }}</a-link>
                          <a-link v-if="item.backupInterfaceId" :style="{ color: '#86909C' }">{{ item.backupInterfaceId }}</a-link>
                        </template>
                        <template v-else>
                          <a-link v-if="item.primaryInterfaceId" :style="{ color: 'var(--subapp-primary)' }">{{ item.primaryInterfaceId }}</a-link>
