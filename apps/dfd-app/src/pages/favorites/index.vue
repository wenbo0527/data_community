            ...
            <div class="item-header">
              ...
              <div class="item-actions">
                <a-button type="text" size="mini" @click.stop="toggleMetricFavorite(m)">
                  <IconHeart :style="{ color: m.isFavorite ? 'var(--subapp-danger)' : 'var(--subapp-text-tertiary)' }" />
                </a-button>
              </div>
            </div>
            ...
            <div class="item-header">
              ...
              <div class="item-actions">
                <a-button type="text" size="mini" @click.stop="toggleExternalFavorite(e)">
                  <IconHeart :style="{ color: e.isFavorite ? 'var(--subapp-danger)' : 'var(--subapp-text-tertiary)' }" />
                </a-button>
              </div>
            </div>
            <div class="item-content">
            ...
            <div class="item-header">
              ...
              <div class="item-actions">
                <a-button type="text" size="mini" @click.stop="toggleVariableFavorite(v)">
                  <IconHeart :style="{ color: v.isFavorite ? 'var(--subapp-danger)' : 'var(--subapp-text-tertiary)' }" />
                </a-button>
              </div>
            </div>
            <div class="item-content">
...
import FavoriteTable from '@/pages/data-map/components/FavoriteTable.vue'
...
const getTypeColor = (type) => {
  switch (type) {
    case 'table': return 'var(--subapp-primary)'
    case 'metric': return 'var(--subapp-success)'
