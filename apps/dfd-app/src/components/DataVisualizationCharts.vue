...
const colorThemes = {
  light: {
    primary: ['var(--subapp-info)', '#52c41a', '#faad14', '#f5222d', 'var(--subapp-info)', 'var(--subapp-info)'],
    background: '#ffffff',
    text: '#333333',
    grid: 'var(--subapp-border)'
  },
  dark: {
    primary: ['#177ddc', '#49aa19', '#d89614', '#d32029', '#642ab5', '#0fb5b5'],
    background: 'var(--subapp-text-primary)',
    text: '#ffffff',
    grid: '#404040'
  }
}
...
.chart-loading::before {
  ...
  border-top: 2px solid var(--subapp-info);
  border-radius: 50%;
