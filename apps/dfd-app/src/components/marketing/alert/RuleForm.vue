    ...
    <a-form-item v-if="showNotifyContent">
      <template #label>
        ...
        <a-tooltip position="right">
          ...
          <IconQuestionCircle style="margin-left:6px;color:var(--subapp-text-tertiary);cursor:pointer" />
        </a-tooltip>
      </template>
...
.option-description { color: var(--subapp-text-tertiary); font-size: 12px; }
...
.form-tip { display: flex; align-items: center; gap: 6px; color: var(--subapp-text-tertiary); font-size: 12px; margin-top: 8px; }
...
.section-title { margin: 0; font-size: 15px; font-weight: 600; color: var(--subapp-text-primary); }
.section-subtitle { margin: 0; font-size: 13px; color: var(--subapp-text-tertiary); }
.summary-block { margin-top: 8px; }
.summary-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; }
.summary-item { display: flex; justify-content: space-between; background: #f7f8fa; border: 1px solid var(--subapp-border); border-radius: 6px; padding: 8px 10px; }
.summary-label { color: var(--subapp-text-secondary); font-size: 13px; }
.summary-value { color: var(--subapp-text-primary); font-weight: 500; }
...
.metric-expression { color: var(--subapp-text-secondary); font-size: 13px; }
.metric-expression.muted { color: var(--subapp-text-tertiary); }
.metric-table-header { padding: 0 10px; margin-bottom: 8px; }
.header-cell { font-size: 13px; color: var(--subapp-text-secondary); font-weight: 600; }
...
.inline-label { font-size: 13px; color: var(--subapp-text-secondary); }
.value-input { display: flex; align-items: center; gap: 6px; }
.unit-suffix { color: var(--subapp-text-secondary); }
.summary-label { color: var(--subapp-text-tertiary); font-size: 12px; }
.recipients-card { background-color: #f7f8fa; margin-top: 8px; }
.panel-card { background-color: #f7f8fa; margin-top: 8px; }
.recipients-card h4 { margin: 0 0 8px 0; color: var(--subapp-text-primary); font-size: 14px; font-weight: 500; }
.recipient-list { margin-top: 8px; }
.recipient-item { margin-bottom: 8px; padding: 12px; background: white; border-radius: 6px; border: 1px solid var(--subapp-border); }
.error-text { color: var(--subapp-danger); font-size: 12px; margin-top: 4px; }
.batch-input { margin-top: 12px; padding: 12px; background: white; border-radius: 6px; border: 1px solid var(--subapp-border); }
</style>
