...
.title { font-weight: 600; color: var(--subapp-text-primary); }
.controls { display: inline-flex; align-items: center; gap: 8px; }
.label { font-size: 12px; color: var(--subapp-text-tertiary); }
...
.group-count { font-size: 12px; color: var(--subapp-text-tertiary); background: var(--subapp-border); padding: 1px 6px; border-radius: 8px; }
