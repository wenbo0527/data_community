        ...
        <g class="nodes">
          ...
          >
            <rect 
              ...
              :stroke="node.highlighted ? 'var(--subapp-primary)' : 'var(--subapp-border)'"
...
const getConnectionColor = (type: string): string => {
  switch (type) {
    case 'and': return 'var(--subapp-primary)'
    case 'or': return 'var(--subapp-success)'
    default: return 'var(--subapp-text-tertiary)'
  }
}
