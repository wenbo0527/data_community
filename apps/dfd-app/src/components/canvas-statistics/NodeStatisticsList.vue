...
.node-icon {
  ...
  &.end { background: var(--subapp-danger); }
  &.condition { background: #fa8c16; }
  &.action { background: var(--subapp-info); }
  &.delay { background: var(--subapp-info); }
  &.tag { background: var(--subapp-info); }
...
.progress-fill {
  ...
  &.poor { background: var(--subapp-danger); }
}
