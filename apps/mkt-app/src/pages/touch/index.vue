  ...
  <div class="touch-home">
    ...
    <div class="task-detail">
      ...
      <a-table :data="filteredData" :pagination="pagination" @page-change="onPageChange">
        <template #columns>
          <a-table-column title="策略ID" data-index="taskId" :width="150" />
          <a-table-column title="MA任务名称" data-index="taskName" :width="200" />
          <a-table-column title="MA任务ID" data-index="maId" :width="120" />
          <a-table-column title="任务执行批次" data-index="executeTime" :width="150" />
          <a-table-column title="触达类型" data-index="reachType" :width="120" />
