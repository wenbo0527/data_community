    ...
    <div class="preview-container">
      ...
      <div class="preview-header">
        <div class="preview-title">
          <IconCheckCircle class="title-icon" />
          <span>规则配置预览</span>
        </div>
        ...
        <a-card class="preview-section" title="触发条件">
          ...
          <div class="conditions-preview">
            ...
            <div v-else class="empty-conditions">
              <IconExclamationCircle class="empty-icon" />
              <span>未配置触发条件</span>
            </div>
          </div>
        </a-card>
            ...
            <div v-if="formData.notifications?.channels?.length" class="channels-list">
              <div class="channel-section">
                ...
                <a-space wrap>
                  ...
                  >
                    <template #icon>
                      <IconWechat v-if="channel === 'wechat'" />
                      <IconMessage v-else-if="channel === 'sms'" />
                      <IconEmail v-else-if="channel === 'email'" />
                    </template>
