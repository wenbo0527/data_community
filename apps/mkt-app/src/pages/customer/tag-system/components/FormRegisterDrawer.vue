    ...
    <div class="form-register">
      ...
      <a-collapse v-model:active-key="activeKeys" :bordered="false">
        ...
        <a-collapse-item key="basic" header="基础配置">
          <template #extra>
            <IconCheckCircle v-if="basicCompleted" style="color: var(--subapp-success)" />
          </template>
        ...
        <a-collapse-item key="fields" header="字段配置">
          <template #extra>
            <IconCheckCircle v-if="fieldsCompleted" style="color: var(--subapp-success)" />
          </template>
        ...
        <a-collapse-item key="mapping" header="IDMapping配置">
          <template #extra>
            <IconCheckCircle v-if="mappingCompleted" style="color: var(--subapp-success)" />
          </template>
