...
.stat-icon {
  ...
  height: 48px;
  border-radius: 8px;
  background: linear-gradient(135deg, var(--subapp-primary) 0%, var(--subapp-primary) 100%);
  color: white;
  font-size: 24px;
  
  &.active {
    background: linear-gradient(135deg, var(--subapp-success) 0%, var(--subapp-success) 100%);
  }
  
  &.archived {
    background: linear-gradient(135deg, var(--subapp-text-tertiary) 0%, #6b7280 100%);
  }
}
