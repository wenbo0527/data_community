    ...
    <a-card title="标签系统" :bordered="false">
      <a-row :gutter="[24, 24]">
        <a-col :span="8">
          ...
          >
            <div class="nav-card-content">
              <div class="nav-icon">
                <IconStorage style="font-size: 48px; color: var(--subapp-primary)" />
              </div>
              <div class="nav-info">
                <h3>标签表管理</h3>
        ...
        <a-col :span="8">
          ...
          >
            <div class="nav-card-content">
              <div class="nav-icon">
                <IconTags style="font-size: 48px; color: var(--subapp-info)" />
              </div>
              <div class="nav-info">
                <h3>标签管理</h3>
        ...
        <a-col :span="8">
          ...
          >
            <div class="nav-card-content">
              <div class="nav-icon">
                <IconList style="font-size: 48px; color: var(--subapp-warning)" />
              </div>
              <div class="nav-info">
                <h3>属性管理</h3>
      ...
      <div class="recent-activities">
        ...
        <a-timeline>
          <a-timeline-item>
            <template #dot>
              <IconCheckCircle style="color: var(--subapp-success)" />
            </template>
          ...
          <a-timeline-item>
            <template #dot>
              <IconEdit style="color: var(--subapp-primary)" />
            </template>
            <div class="activity-content">
          ...
          <a-timeline-item>
            <template #dot>
              <IconSettings style="color: var(--subapp-warning)" />
            </template>
            <div class="activity-content">
        ...
        >
          <template #upload-button>
            <div class="upload-content">
              <IconPlus style="font-size: 32px; color: var(--subapp-primary)" />
              <p>点击或拖拽文件到此处上传</p>
