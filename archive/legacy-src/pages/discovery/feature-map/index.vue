    ...
    <div class="search-section">
      ...
      <div v-if="showAdvancedFilter" class="advanced-filter-panel">
        <a-row :gutter="16">
          <a-col :span="6">
            <a-select 
              v-model="advancedFilters.featureType" 
              placeholder="特征类型" 
              allow-clear
            >
          ...
          <a-col :span="6">
            <a-select 
              v-model="advancedFilters.majorCategory" 
              placeholder="业务类型" 
              allow-clear
            >
...
const resetAdvancedFilters = () => {
  advancedFilters.featureType = ''
  advancedFilters.majorCategory = ''
...
const applyAdvancedFilters = async () => {
  ...
  if (advancedFilters.majorCategory) {
    featureFilter.majorCategory = advancedFilters.majorCategory
  }
